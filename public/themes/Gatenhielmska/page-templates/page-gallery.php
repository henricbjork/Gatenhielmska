...
<section class="gallery-container">
    ...
    <div class="gallery-videos">
        ...
        <button class="video-more-btn">VISA FLER VIDEOS<img class="video-shrink-btn" src="<?php echo get_bloginfo('template_directory'); ?>/assets/images/minimize-white.svg" alt=""><button>
    </div>
</section>
<?php get_footer();
