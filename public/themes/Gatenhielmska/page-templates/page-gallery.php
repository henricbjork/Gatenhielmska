...
<section class="gallery-container">
    ...
    <button class="gallery-less-btn">MINIMERA<img class="shrink-icon" src="<?php echo get_bloginfo('template_directory'); ?>/assets/images/minimize-white.svg" alt=""></button>
    ...
    <button class="video-less-btn">MINIMERA<img class="video-shrink-icon" src="<?php echo get_bloginfo('template_directory'); ?>/assets/images/minimize-white.svg" alt=""></button>
</section>
<?php get_footer();
